---
permalink: /2026/03/16/human-microbiome.html
layout: post
...
For years, a commonly cited statistic was that microbial cells in and on the human body outnumber human cells by roughly 10 to 1. More recent analyses revised that estimate: using updated cell counts for human tissues and better sampling of microbiota, researchers now estimate the ratio is closer to 1:1, though it varies substantially by individual, age, diet, and body site.
